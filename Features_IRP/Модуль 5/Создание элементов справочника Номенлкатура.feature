...
провести нагрузочное тестирование создания элементов справочника Номенклатура 
чтобы проверить стабильность работы системы

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: создание элементов справочника Номенклатура
	*Запоминание стартового значения счетчика
